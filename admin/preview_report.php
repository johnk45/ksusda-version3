...
<?php
// preview_report.php - Handle missing folders/files gracefully

$file_path = $report['file_path'];
$full_server_path = $_SERVER['DOCUMENT_ROOT'] . '/UPGRADED KSUSDA WEBSITE/' . $file_path;
...
if (!file_exists($full_server_path)) {
    ...
    echo '<p>The file may have been moved or deleted.</p>';
    echo '<p><strong>Expected location:</strong> ' . htmlspecialchars($file_path) . '</p>';
    echo '<a href="upload_report.php" class="btn btn-primary">Upload New Report</a>';
    echo '</div>';
    exit;
}
